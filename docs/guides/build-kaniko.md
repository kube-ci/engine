...
```console
$ kubectl apply -f ./docs/examples/build-kaniko/secret.yaml 
...
```console
$ kubectl apply -f ./docs/examples/build-kaniko/workflow.yaml
...
```console
$ kubectl apply -f ./docs/examples/build-kaniko/trigger.yaml 
...
```console
$ kubectl delete -f ./docs/examples/build-kaniko
...
Error from server (NotFound): error when deleting "docs/examples/build-kaniko/trigger.yaml": the server could not find the requested resource
```
