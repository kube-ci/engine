...
const (
	EventReasonWorkplanSucceeded     = "WorkplanSucceeded"
	EventReasonWorkplanFailed        = "WorkplanFailed"
	EventReasonWorkflowTriggered     = "WorkflowTriggered"
	EventReasonWorkflowTriggerFailed = "WorkflowTriggerFailed"
)
