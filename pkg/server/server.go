...
type KubeciServerConfig struct {
	GenericConfig *genericapiserver.RecommendedConfig
	ExtraConfig   *controller.Config
}

// KubeciServer contains state for a Kubernetes cluster master/api server.
type KubeciServer struct {
...
func (c *KubeciServerConfig) Complete() CompletedConfig {
...
// New returns a new instance of KubeciServer from the given config.
func (c completedConfig) New() (*KubeciServer, error) {
