...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kube.ci/engine/apis/engine/v1alpha1.TriggeredFor":               schema_engine_apis_engine_v1alpha1_TriggeredFor(ref),
		"kube.ci/engine/apis/engine/v1alpha1.Workflow":                   schema_engine_apis_engine_v1alpha1_Workflow(ref),
		"kube.ci/engine/apis/engine/v1alpha1.WorkflowList":               schema_engine_apis_engine_v1alpha1_WorkflowList(ref),
		"kube.ci/engine/apis/engine/v1alpha1.WorkflowSpec":               schema_engine_apis_engine_v1alpha1_WorkflowSpec(ref),
		"kube.ci/engine/apis/engine/v1alpha1.WorkflowTemplate":           schema_engine_apis_engine_v1alpha1_WorkflowTemplate(ref),
		"kube.ci/engine/apis/engine/v1alpha1.WorkflowTemplateList":       schema_engine_apis_engine_v1alpha1_WorkflowTemplateList(ref),
		"kube.ci/engine/apis/engine/v1alpha1.WorkflowTemplateSpec":       schema_engine_apis_engine_v1alpha1_WorkflowTemplateSpec(ref),
		"kube.ci/engine/apis/engine/v1alpha1.Workplan":                   schema_engine_apis_engine_v1alpha1_Workplan(ref),
		"kube.ci/engine/apis/engine/v1alpha1.WorkplanList":               schema_engine_apis_engine_v1alpha1_WorkplanList(ref),
		"kube.ci/engine/apis/engine/v1alpha1.WorkplanSpec":               schema_engine_apis_engine_v1alpha1_WorkplanSpec(ref),
		"kube.ci/engine/apis/engine/v1alpha1.WorkplanStatus":             schema_engine_apis_engine_v1alpha1_WorkplanStatus(ref),
	}
}
...
func schema_engine_apis_engine_v1alpha1_Task(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"SerialSteps": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kube.ci/engine/apis/engine/v1alpha1.Step"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"kube.ci/engine/apis/engine/v1alpha1.Step"},
	}
}
...
func schema_engine_apis_engine_v1alpha1_TriggeredFor(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					"objectReference": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kube.ci/engine/apis/engine/v1alpha1.ObjectReference"),
						},
					},
					"resourceGeneration": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/appscode/go/encoding/json/types.IntHash", "kube.ci/engine/apis/engine/v1alpha1.ObjectReference"},
	}
}
...
func schema_engine_apis_engine_v1alpha1_Workflow(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kube.ci/engine/apis/engine/v1alpha1.WorkflowSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kube.ci/engine/apis/engine/v1alpha1.WorkflowSpec"},
	}
}
...
func schema_engine_apis_engine_v1alpha1_WorkflowList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kube.ci/engine/apis/engine/v1alpha1.Workflow"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kube.ci/engine/apis/engine/v1alpha1.Workflow"},
	}
}
...
func schema_engine_apis_engine_v1alpha1_WorkflowSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"triggers": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kube.ci/engine/apis/engine/v1alpha1.Trigger"),
									},
								},
							},
						},
					...
					"template": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kube.ci/engine/apis/engine/v1alpha1.Template"),
						},
					},
					"executionOrder": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.EnvFromSource", "k8s.io/api/core/v1.EnvVar", "k8s.io/api/core/v1.Volume", "kube.ci/engine/apis/engine/v1alpha1.Step", "kube.ci/engine/apis/engine/v1alpha1.Template", "kube.ci/engine/apis/engine/v1alpha1.Trigger"},
	}
}
...
func schema_engine_apis_engine_v1alpha1_WorkflowTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kube.ci/engine/apis/engine/v1alpha1.WorkflowTemplateSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kube.ci/engine/apis/engine/v1alpha1.WorkflowTemplateSpec"},
	}
}
...
func schema_engine_apis_engine_v1alpha1_WorkflowTemplateList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kube.ci/engine/apis/engine/v1alpha1.WorkflowTemplate"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kube.ci/engine/apis/engine/v1alpha1.WorkflowTemplate"},
	}
}
...
func schema_engine_apis_engine_v1alpha1_Workplan(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kube.ci/engine/apis/engine/v1alpha1.WorkplanSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kube.ci/engine/apis/engine/v1alpha1.WorkplanStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kube.ci/engine/apis/engine/v1alpha1.WorkplanSpec", "kube.ci/engine/apis/engine/v1alpha1.WorkplanStatus"},
	}
}
...
func schema_engine_apis_engine_v1alpha1_WorkplanList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kube.ci/engine/apis/engine/v1alpha1.Workplan"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kube.ci/engine/apis/engine/v1alpha1.Workplan"},
	}
}
...
func schema_engine_apis_engine_v1alpha1_WorkplanSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"tasks": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("kube.ci/engine/apis/engine/v1alpha1.Task"),
									},
								},
							},
						},
					...
					"triggeredFor": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kube.ci/engine/apis/engine/v1alpha1.TriggeredFor"),
						},
					},
					"envVar": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.EnvFromSource", "k8s.io/api/core/v1.EnvVar", "k8s.io/api/core/v1.Volume", "kube.ci/engine/apis/engine/v1alpha1.Task", "kube.ci/engine/apis/engine/v1alpha1.TriggeredFor"},
	}
}
