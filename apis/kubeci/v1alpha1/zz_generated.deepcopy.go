...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceGeneration) DeepCopyInto(out *ResourceGeneration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceGeneration.
func (in *ResourceGeneration) DeepCopy() *ResourceGeneration {
	if in == nil {
		return nil
	}
	out := new(ResourceGeneration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TriggeredFor) DeepCopyInto(out *TriggeredFor) {
	*out = *in
	...
	out.ResourceGeneration = in.ResourceGeneration
	return
}
...
func (in *WorkplanSpec) DeepCopyInto(out *WorkplanSpec) {
	*out = *in
	...
	out.TriggeredFor = in.TriggeredFor
	if in.EnvFrom != nil {
		in, out := &in.EnvFrom, &out.EnvFrom
		*out = make([]v1.EnvFromSource, len(*in))
		for i := range *in {
