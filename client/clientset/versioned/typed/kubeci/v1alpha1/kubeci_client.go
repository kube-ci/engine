...
func (c *KubeciV1alpha1Client) Workplans(namespace string) WorkplanInterface {
	return newWorkplans(c, namespace)
}

// NewForConfig creates a new KubeciV1alpha1Client for the given config.
func NewForConfig(c *rest.Config) (*KubeciV1alpha1Client, error) {
	config := *c
	...
	return &KubeciV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new KubeciV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *KubeciV1alpha1Client {
...
// New creates a new KubeciV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *KubeciV1alpha1Client {
	return &KubeciV1alpha1Client{c}
}
...
func (c *KubeciV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
