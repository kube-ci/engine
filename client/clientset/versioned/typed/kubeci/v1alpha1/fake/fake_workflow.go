...
var workflowsResource = schema.GroupVersionResource{Group: "kubeci.kube.ci", Version: "v1alpha1", Resource: "workflows"}

var workflowsKind = schema.GroupVersionKind{Group: "kubeci.kube.ci", Version: "v1alpha1", Kind: "Workflow"}
