...
var workflowsResource = schema.GroupVersionResource{Group: "engine.kube.ci", Version: "v1alpha1", Resource: "workflows"}

var workflowsKind = schema.GroupVersionKind{Group: "engine.kube.ci", Version: "v1alpha1", Kind: "Workflow"}
