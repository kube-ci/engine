...
var triggersResource = schema.GroupVersionResource{Group: "extensions.kube.ci", Version: "v1alpha1", Resource: "triggers"}

var triggersKind = schema.GroupVersionKind{Group: "extensions.kube.ci", Version: "v1alpha1", Kind: "Trigger"}
