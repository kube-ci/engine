	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeciV1alpha1().WorkflowTemplates(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeciV1alpha1().WorkflowTemplates(namespace).Watch(options)
			},
		},
		&kubeci_v1alpha1.WorkflowTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workflowTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubeci_v1alpha1.WorkflowTemplate{}, f.defaultInformer)
}
